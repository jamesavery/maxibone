...
plotting_dir = f'{hdf5_root}/processed/{pathlib.Path(sys.argv[0]).stem}'
'''The directory for the plots generated by the scripts. It is based on the calling (`__main__`) script name.'''